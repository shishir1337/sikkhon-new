      ...
      <div className="bg-blue-950 py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-white text-center max-w-3xl mx-auto">
            ...
            <strong>Microsoft Office, graphic design, web development, data science</strong>, and more. Invest in your
            future with our high-quality, comprehensive learning experiences.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-16 text-center">
          <p className={`${nunito.className} text-lg text-gray-700`}>
            Invest in your future with our premium courses. Get personalized support and earn industry-recognized
            certifications.{" "}
