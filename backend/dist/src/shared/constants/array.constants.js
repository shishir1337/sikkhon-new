...
exports.WithdrawStatusArray = exports.ReviewRatingArray = exports.AnswerStatusArray = exports.AnswerTypeArray = exports.FileTypeArray = exports.PrivacyPolicySlugs = exports.TermsConditionSlugs = exports.TermsPrivacySlugs = exports.CourseStatusTypeArray = exports.CouponUsesTypeArray = exports.DiscountTypeArray = exports.GenderTypeArray = exports.VerificationTypeArray = exports.ReviewArray = exports.AgoraCredentialsSlug = exports.InstructorSettingsDataSlugs = exports.BusinessSettingsDataSlug = exports.LandingHowItWorkSectionDataSlugs = exports.LandingChooseUsSectionDataSlugs = exports.LandingAboutUsSectionDataSlugs = exports.LandingMainBannerDataSlugs = exports.LandingPageSlugs = exports.LanguageListJsonArray = exports.CountryListObjectArray = exports.FaqTypeArray = exports.InputFieldTypeArray = exports.PackageTypeArray = exports.AdminRolesArray = exports.UserRolesArray = exports.StatusOnOffArray = exports.ModeStatusArray = exports.PaymentMethodBraintreeSettingsSlugs = exports.GithubAuthCredentialsSlugs = exports.GoogleAuthCredentialsSlugs = exports.PaymentMethodPaystackSettingsSlugs = exports.PaymentMethodRazoarpaySettingsSlugs = exports.PaymentMethodStripeSettingsSlugs = exports.SMTPSettingsSlugs = exports.GeneralSettingsSlugs = exports.CommonSettingsSlugs = void 0;
const coreConstant_1 = require("../helpers/coreConstant");
exports.CommonSettingsSlugs = [
    'site_name',
...
exports.PaymentMethodStripeSettingsSlugs = [
    'pm_stripe_client_id_live',
    'pm_stripe_secret_key_live',
];
exports.PaymentMethodRazoarpaySettingsSlugs = [
    'payment_razorpay_key_id',
    'payment_razorpay_key_secret',
];
exports.PaymentMethodPaystackSettingsSlugs = [
    'payment_paystack_public_key',
    'payment_paystack_key_secret',
    'payment_paystack_redirect_url',
];
exports.GoogleAuthCredentialsSlugs = [
    'google_auth_client_id',
    'google_auth_client_secret',
];
exports.GithubAuthCredentialsSlugs = [
    'github_auth_client_id',
    'github_auth_client_secret',
];
exports.PaymentMethodBraintreeSettingsSlugs = [
...
exports.ModeStatusArray = [
    coreConstant_1.modeStatusConstant.LIVE,
    coreConstant_1.modeStatusConstant.SANDBOX,
];
exports.StatusOnOffArray = [
    coreConstant_1.statusOnOffConstant.DEACTIVE,
    coreConstant_1.statusOnOffConstant.ACTIVE,
];
exports.UserRolesArray = [
    coreConstant_1.coreConstant.ROLES.INSTRUCTOR,
    coreConstant_1.coreConstant.ROLES.STUDENT,
];
exports.AdminRolesArray = [
    coreConstant_1.coreConstant.ROLES.ADMIN,
    coreConstant_1.coreConstant.ROLES.SUPER_ADMIN,
];
exports.PackageTypeArray = [
    coreConstant_1.packageTypeConstant.REGULAR,
    coreConstant_1.packageTypeConstant.PREMIUM,
];
exports.InputFieldTypeArray = [
    coreConstant_1.inputFieldTypeConstant.INPUT_FIELD,
    coreConstant_1.inputFieldTypeConstant.TEXTAREA_FIELD,
];
exports.FaqTypeArray = [coreConstant_1.faqTypeConstant.LANDING_PAGE];
exports.CountryListObjectArray = [
...
exports.LandingMainBannerDataSlugs = [
    'landing_main_banner_first_title',
    'landing_main_banner_first_description',
    'landing_main_banner_image_url',
];
exports.LandingAboutUsSectionDataSlugs = [
    'landing_about_us_first_title',
    'landing_about_us_first_description',
    'landing_about_us_bullet_point',
    'landing_about_us_first_image_url',
...
exports.LandingChooseUsSectionDataSlugs = [
    'landing_choose_us_first_title',
    'landing_choose_us_list_first_title',
    'landing_choose_us_list_first_description',
    'landing_choose_us_list_second_title',
...
exports.LandingHowItWorkSectionDataSlugs = [
    'landing_how_it_work_first_title',
    'landing_how_it_work_list_first_title',
    'landing_how_it_work_list_first_description',
    'landing_how_it_work_list_second_title',
...
exports.BusinessSettingsDataSlug = ['withdraw_percentage'];
exports.InstructorSettingsDataSlugs = ['instructor_signature'];
exports.AgoraCredentialsSlug = [
    'agora_status',
    'agora_app_id',
    'app_certificate',
];
exports.ReviewArray = [1, 2, 3, 4, 5];
exports.VerificationTypeArray = [
    coreConstant_1.coreConstant.IS_NOT_VERIFIED,
    coreConstant_1.coreConstant.IS_VERIFIED,
    coreConstant_1.coreConstant.IS_REJECTED,
];
exports.GenderTypeArray = [
    coreConstant_1.coreConstant.GENDER.FEMALE,
    coreConstant_1.coreConstant.GENDER.MALE,
    coreConstant_1.coreConstant.GENDER.OTHERS,
];
exports.DiscountTypeArray = [
    coreConstant_1.DiscountConstant.DISCOUNT_FIXED,
    coreConstant_1.DiscountConstant.DISCOUNT_PERCENTAGE,
];
exports.CouponUsesTypeArray = [
    coreConstant_1.CouponUsesTypeConstant.LIMITED_USER,
    coreConstant_1.CouponUsesTypeConstant.UNLIMITED_USER,
];
exports.CourseStatusTypeArray = [
...
exports.TermsPrivacySlugs = [
    'privacy_policy_status',
    'privacy_policy',
    'terms_condition_status',
    'terms_condition',
];
exports.TermsConditionSlugs = [
    'terms_condition_status',
    'terms_condition',
];
exports.PrivacyPolicySlugs = ['privacy_policy_status', 'privacy_policy'];
exports.FileTypeArray = [
    coreConstant_1.FileTypeConstant.NONE,
    coreConstant_1.FileTypeConstant.IMAGE,
    coreConstant_1.FileTypeConstant.VIDEO,
];
exports.AnswerTypeArray = [
    coreConstant_1.AnswerTypeConstant.MULTIPLE_CHOICE,
    coreConstant_1.AnswerTypeConstant.DESCRIPTION,
];
exports.AnswerStatusArray = [
    coreConstant_1.AnswerStatusConstant.WRONG_ANSWER,
    coreConstant_1.AnswerStatusConstant.RIGHT_ANSWER,
];
exports.ReviewRatingArray = [
    coreConstant_1.ReviewRatingConstant.ONE_STAR,
    coreConstant_1.ReviewRatingConstant.TWO_STAR,
    coreConstant_1.ReviewRatingConstant.THREE_STAR,
    coreConstant_1.ReviewRatingConstant.FOUR_STAR,
    coreConstant_1.ReviewRatingConstant.FIVE_STAR,
];
exports.WithdrawStatusArray = [
    coreConstant_1.WithdrawStatusConstant.PENDING,
    coreConstant_1.WithdrawStatusConstant.ACCEPTED,
    coreConstant_1.WithdrawStatusConstant.REJECTED,
];
//# sourceMappingURL=array.constants.js.map