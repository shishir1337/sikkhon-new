...
import { useUserVerifyEmailHandler } from "@/hooks/auth.hook";
      ...
      >
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
            Enter your email and verification code to complete the process
          </p>
        </div>
        <Form {...form}>
          <form className="mt-8 space-y-6" onSubmit={form.handleSubmit(handleVerifyEmail)}>
