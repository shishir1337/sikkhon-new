...
import { useUpdateLessonForAdminFormHandler } from "@/hooks/admin/course.hook";
import {
...
export default function EditLessonCompForAdmin({ activeLesson }: any) {
  const {
    data: courseDetails,
    form,
    isLoading,
    ...
    isSuccess,
    handleLesonSettings,
  } = useUpdateLessonForAdminFormHandler();
